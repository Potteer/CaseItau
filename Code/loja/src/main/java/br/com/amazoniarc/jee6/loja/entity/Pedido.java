package br.com.amazoniarc.jee6.loja.entity;
...
public class Pedido implements Serializable {
  ...
  public void aplicarCupom() {
    ...
    for (ItemPedido item : getItens()) {
      Double novoValor = item.getPrecoUnitario() - (item.getPromocao() * 0.1);
      item.setPrecoUnitario(novoValor);
      item.calcularTotal();
  ...
  public String toString() {
    return "Pedido [id=" + id + ", data=" + data + ", itens=" + itens + ", valorTotal=" + valorTotal + "]";
  }
